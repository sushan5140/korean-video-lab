...
const QUERIES={"Daily Life":["한국어 중급 일상 생활 대화 듣기","Korean intermediate daily life conversation podcast"],"Food":["한국어 음식 요리 식당 대화 듣기","Korean intermediate food cooking eating listening podcast"],"Travel":["한국어 여행 일상 대화 듣기","Korean intermediate travel vacation vlog conversation"],"Shopping":["한국어 쇼핑 물건 사기 대화 듣기","Korean shopping market conversation listening"],"School":["한국어 학교 대학 공부 시험 대화","Korean intermediate school college classroom story"],"Culture":["한국 문화 생활 명절 한국어 듣기","Korean intermediate culture etiquette tradition podcast"],"Weather":["한국어 날씨 계절 듣기 Korean podcast","intermediate Korean weather seasons rain snow podcast","날씨 한국어 중급 이야기"],"Family":["한국어 가족 이야기 듣기 Korean podcast","Korean listening talking about family parents siblings","중급 한국어 가족 부모 자녀 대화"],"Work":["한국어 회사 직장 일 취업 듣기","Korean intermediate job office work conversation"],"Hobbies":["한국어 취미 생활 듣기 Korean podcast","Korean listening hobbies interests exercise movies","한국어 취미 운동 여가 이야기 중급"]};
...
function respond(res,code,data){res.statusCode=code;res.setHeader('Content-Type','application/json; charset=utf-8');res.setHeader('Cache-Control',code===200?'public, s-maxage=86400, stale-while-revalidate=604800':'no-store');res.end(JSON.stringify(data))}
