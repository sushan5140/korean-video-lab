...
module.exports = async function handler(req, res) {
  ...
  // AI insight access is granted by admin role, redeemed referral, or a direct admin grant.
  const invite = await fetch(SUPABASE_URL + '/rest/v1/rpc/haneul_has_ai_access', {
    method: 'POST',
    headers: {
